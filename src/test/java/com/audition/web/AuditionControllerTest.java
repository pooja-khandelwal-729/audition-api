...
class AuditionControllerTest {
    ...
    void testGetPostsById() {
        ...
        final AuditionPost actualPost = auditionController.getPostById("1");
    ...
    void testGetPostsByInvalidId() {
        assertThrows(IllegalArgumentException.class, () -> auditionController.getPostById("abc"));
    }
    ...
    void testGetCommentsByInvalidPostId() {
        assertThrows(IllegalArgumentException.class, () -> auditionController.getCommentsForPost(0));
    }
